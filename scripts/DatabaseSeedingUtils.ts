...
import { SURVEYJS_TEMPLATES } from "./surveyTemplates";
...
// SurveyJS survey templates live in ./surveyTemplates so they can be read without a DB env.
export { SURVEYJS_TEMPLATES };
