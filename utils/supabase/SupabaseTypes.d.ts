  ...
  public: {
    Tables: {
      ...
      gradebook_column_groups: {
        ...
        Relationships: [
          {
            foreignKeyName: "gradebook_column_groups_gradebook_fkey";
      ...
      gradebook_columns: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "gradebook_columns_group_fkey";
            columns: ["gradebook_id", "group_id"];
            isOneToOne: false;
            referencedRelation: "gradebook_column_groups";
            referencedColumns: ["gradebook_id", "id"];
          }
        ];
      };
    ...
    Functions: {
      ...
      get_assignments_for_student_dashboard: {
        ...
        Returns: {
          ...
          archived_at: string;
          assignment_self_review_setting_id: number;
          autograder_points: number;
          class_id: number;
          created_at: string;
          description: string;
          due_date: string;
          due_date_exception_id: number;
          exception_created_at: string;
          exception_creator_id: string;
          exception_hours: number;
          exception_minutes: number;
          exception_note: string;
          exception_tokens_consumed: number;
          gradebook_column_id: number;
          grader_result_id: number;
          grader_result_max_score: number;
          grader_result_score: number;
          grading_rubric_id: number;
          grading_submission_review_completed_at: string;
          grading_submission_review_id: number;
          grading_total_score: number;
          group_config: Database["public"]["Enums"]["assignment_group_mode"];
          group_formation_deadline: string;
          has_autograder: boolean;
          has_handgrader: boolean;
          id: number;
          is_github_ready: boolean;
          latest_template_sha: string;
          max_group_size: number;
          max_late_tokens: number;
          meta_grading_rubric_id: number;
          min_group_size: number;
          minutes_due_after_lab: number;
          release_date: string;
          repository: string;
          repository_id: number;
          review_assignment_id: number;
          review_submission_id: number;
          self_review_deadline_offset: number;
          self_review_enabled: boolean;
          self_review_rubric_id: number;
          self_review_setting_id: number;
          slug: string;
          student_profile_id: string;
          student_repo_prefix: string;
          student_user_id: string;
          submission_created_at: string;
          submission_id: number;
          submission_is_active: boolean;
          submission_ordinal: number;
          submission_review_completed_at: string;
          submission_review_id: number;
      ...
      gradebook_column_dependency_ids: {
        Args: { p_dependencies: Json };
        Returns: number[];
      };
      gradebook_column_family: { Args: { p_slug: string }; Returns: string };
      gradebook_column_family_title: {
        Args: { p_family: string };
        Returns: string;
      };
      gradebook_column_group_clean_name: {
        Args: { p_name: string };
        Returns: string;
      };
      ...
      gradebook_column_group_free_name: {
      ...
      gradebook_column_groups_check_direction: {
        Args: { p_direction: number };
        Returns: undefined;
      };
      gradebook_column_groups_torn: {
        Args: { p_gradebook_id: number };
        Returns: boolean;
      };
      ...
      gradebook_columns_broadcast_order: {
        Args: { p_column_ids: number[]; p_gradebook_id: number };
        Returns: undefined;
      };
      ...
      gradebook_columns_order_payload: {
        Args: { p_audience: string; p_class_id: number; p_column_ids: number[] };
        Returns: Json;
      };
